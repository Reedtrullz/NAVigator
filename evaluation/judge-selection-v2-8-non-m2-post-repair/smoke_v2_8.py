#!/usr/bin/env python3
"""V2.8 transport smoke per spec section 25. One synthetic non-benchmark call per candidate."""
...
CTX = 'Smoke test: syntetisk kontekst for transportverifisering.'
...
def main():
    results = {'task_id': 'NAV-EXPLORE-JUDGE-SELECTION-V2_8-NON-M2-POST-REPAIR-SCREENING',
