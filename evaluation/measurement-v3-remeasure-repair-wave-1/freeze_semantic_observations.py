#!/usr/bin/env python3
"""Section 20: freeze all semantic observations before gold derivation."""
import hashlib
import json
import os
import time
...
def main():
    ...
    files = ["astra-pass-a.jsonl", "astra-pass-b.jsonl",
             ...
             "residual-inputs.json", "adjudication-pass-a.jsonl",
             "adjudication-pass-b.jsonl", "adjudication-validation.json",
             "residual-consensus.json", "astra-config.json",
             "astra-transport-log.jsonl", "adjudication-transport-log.json",
             "primary-review-freeze-manifest.json", "authority-map.json"]
    manifest = {
        ...
        "purpose": "Section 20: prevent downstream gold/result knowledge from "
