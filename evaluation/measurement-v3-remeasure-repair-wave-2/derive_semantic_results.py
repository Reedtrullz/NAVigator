#!/usr/bin/env python3
"""Section 22: mechanical derivation of the 94 semantic criteria.
...
def main():
    ...
    for p in consensus["packets"]:
        ...
        derived.append({
            ...
            "observation_source": "ASTRA_WAVE2_DUAL_PASS_CONSENSUS",
    ...
    for p in residual["packets"]:
        ...
        if p["consensus_status"] == "LLM_ADJUDICATION_CONSENSUS":
            ...
            derived.append({
                ...
                "observation_source": "SOL_WAVE2_DUAL_PASS_RESIDUAL_CONSENSUS",
    ...
    assert len(derived) + len(pending) == 94, (len(derived), len(pending))
