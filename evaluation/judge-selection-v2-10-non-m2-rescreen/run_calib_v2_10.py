#!/usr/bin/env python3
"""V2.10 burned calibration runner. Per-row checkpointing; no reruns.

 Usage: python3 run_calib_v2_10.py <iteration>
...
def main():
    ...
    fx_all = json.load(open(HERE / 'calibration-fixtures-v2-10.json'))['fixtures']
