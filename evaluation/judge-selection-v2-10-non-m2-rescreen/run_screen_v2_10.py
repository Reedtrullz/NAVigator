#!/usr/bin/env python3
"""V2.10 one-shot official screening runner. Per-row checkpointing; no reruns.
Execution order: IDs ascending, DeepSeek complete, then MiMo Pro complete.
Deterministic-resolved fixtures consume zero judge calls."""
