#!/usr/bin/env python3
"""V2.10 gate evaluator.

FROZEN_DRAFT_ARTIFACT: preregistered and SHA-pinned before any V2.9
candidate call. Verbatim copy of the V2.8/V2.9 scorer logic (sha
...
official V2.10 result is observed.
"""
import json, hashlib
...
def main():
    ...
    residual_scores = {}
    repair_report = {}
    coverage = {"task_id": "NAV-EXPLORE-JUDGE-SELECTION-V2_10-BOUNDARY-EXTENSION-AND-RESCREEN",
                "total_non_m2_n": 180,
