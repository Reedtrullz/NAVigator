# Uncertainty Decision Tree v2.7e

Frozen order (frozen 2026-09-13, Set A-calibrated: 32/32 agreement, both zero-gates pass). Annotators and judges follow these steps in sequence.
